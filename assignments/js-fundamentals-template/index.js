...
*/
        applicant1.address = { state: 'MD', city: 'Baltimore', zipCode: 21201 };
...
const isEligibleApplicant = (applicant) => {
    return applicant.age >= 18? true : false;
}
...
const isActiveApplicant = (applicant) => {
    return applicant.programStatus === "Active"? true: false;
}
...
const runsScored = (innings) => {
    ...
    for (const inning of innings) {
        totalRuns = totalRuns + inning
    }
    //TODO: Don't forget to return the totalRuns!
    return totalRuns;
    //you could also use array.reduce here instead!!
}
...
const filterApplicantsByEligibility = (applicants) => {
    let eligibleStudents = []; //TODO: fill in the correct logic for this function
    for (const applicant of applicants) {
         if (applicant.age >= 18) {
            eligibleStudents.push(applicant);
         }
    }
...
const filterApplicantsByProgramStatus = (applicants) => {
    let activeStudents = []; //TODO: fill in the correct logic for this function
    for (const applicant of applicants) {
